...
#### Summary
According to figure graph\@ref(fig:topfiveplot), except Diarrheal disease, all the other four disease is increasing from 2000 until now.Lower respiratory infections death reached the peak around 2015, and begin to decrease in recent years.
For Mozambique, the death rate of Cardiovascular disease was increasing from 2000 unitl now. Death number for HIV and Tuberculosis reached the peak in around 2013 and begin to drop.The death number of Malaria and Neonatal disorder is deceasing from 2000 until now.
