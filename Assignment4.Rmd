...
```{r Mexicofigure,fig.cap = "Deaths by cause in Mexico"}
...
gridExtra::grid.arrange(Mexico_plot, nrow = 2)
```

```{r Germanyfigure,fig.cap = "Deaths by cause in Germany"}
...
gridExtra::grid.arrange(Germany_plot, nrow = 2)
```
